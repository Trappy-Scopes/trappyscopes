...
# | $$    $$| $$  | $$   | $$   | $$  | $$| $$  | $$| $$  | $$| $$            | $$      | $$      | $$  | $$
# |  $$$$$$/| $$  | $$   | $$   | $$  | $$|  $$$$$$/| $$$$$$$/| $$$$$$$$      | $$$$$$$$| $$$$$$$$| $$$$$$$/
#  \______/ |__/  |__/   |__/   |__/  |__/ \______/ |_______/ |________/      |________/|________/|_______/                                                                                                           
...
class CAPwmRgbLed(Light):
	...
	#2
	def on(lux=0.0, ch=self.channels):
	    """
	...
	#4
	def block(self, ch=self.channels):
	...
	#10
	@abstractmethod
	def sweep(self, period_s=0.1, steps= 20, ch=self.channels):
	...
	#11
	@abstractmethod            
	def set_max(self, ch=self.channels):
	...
	def mixer(self, color, lux=1.0):
		...
		for val, ch in enumerate("rgb"):
			self.set_ch(ch, lux=val)
	...
	def strobe(self, switch, timer=None):
		...
		if switch:
			timer.deinit()
			timer.init(freq=1, mode=Timer.PERIODIC, callback=toggler)
		else:
			timer.deinit()
